...
This folder contains the editable and rendered versions of Honglang Wang's seminar flyer.

- `index.qmd`: editable Quarto source containing the flyer design and seminar content
- `HonglangWang.JPG`: profile image used by the flyer
- `index.html`: self-contained HTML flyer with the profile image embedded
- `HonglangWang-flyer.png`: high-resolution PNG flyer
